...
function openlink(x) {
    if (x == 1) {
        window.open("https://x.com/nitin_yadav_213", "_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/nitin-yadav-8724552bb/", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/nitinyadav213", "_blank");
    }
    if (x == 4) {
        window.open("https://www.instagram.com/_nitin_yadav_213?igsh=YjBzMzNqZ2pmY3hh", "_blank");
    }
}